        ...
        <main>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="{{route('informations.sort')}}">سن</a></li>
                </ul>
            </div>
            <br>
            <div class="row g-3">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$sort->first_name}}</td>
                                <td>{{$sort->last_name}}</td>
                                <td>
                                    @if($sort->gender == 'male')
                                    {{'آقا'}}
                                    @else
