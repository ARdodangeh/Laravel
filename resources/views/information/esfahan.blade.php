            ...
            <div class="row g-3">
                <div class="col">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($esfahans as $esfahan)
                            <tr>
                                <th scope="row">{{$esfahan->id}}</th>
                                <td>{{$esfahan->first_name}}</td>
                                <td>{{$esfahan->last_name}}</td>
                                <td>
                                    @if($esfahan->gender == 'male')
                                    {{'آقا'}}
                                    @else
                                    {{'خانم'}}
                                    @endif
                                ...
                                <td>
                                    @if($esfahan->city == 'tehran')
                                    {{'تهران'}}
                                    @elseif($esfahan->city == 'mashhad')
                                    {{'مشهد'}}
                                    @else
                                    {{'اصفهان'}}
                                    @endif
