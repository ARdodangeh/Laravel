            ...
            <div class="row g-3">
                <div class="col">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($tehrans as $tehran)
                            <tr>
                                <th scope="row">{{$tehran->id}}</th>
                                <td>{{$tehran->first_name}}</td>
                                <td>{{$tehran->last_name}}</td>
                                <td>
                                    @if($tehran->gender == 'male')
                                    {{'آقا'}}
                                    @else
                                    {{'خانم'}}
                                    @endif
                                ...
                                <td>
                                    @if($tehran->city == 'tehran')
                                    {{'تهران'}}
                                    @elseif($tehran->city == 'mashhad')
                                    {{'مشهد'}}
                                    @else
                                    {{'اصفهان'}}
                                    @endif
