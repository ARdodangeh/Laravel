                ...
                <div class="col">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">{{$bachelor->id}}</th>
                                <td>{{$bachelor->first_name}}</td>
                                <td>{{$bachelor->last_name}}</td>
                                <td>
                                    @if($bachelor->gender == 'male')
                                    {{'آقا'}}
                                    @else
                                    {{'خانم'}}
                                    @endif
                                ...
                                <td>{{$bachelor->age}}</td>
                                <td>
                                    @if($bachelor->education == 'Bachelor')
                                    {{'لیسانس'}}
                                    @else
                                    {{'فوق لیسانس'}}
                                    @endif
                                ...
                                <td>
                                    @if($bachelor->city == 'tehran')
                                    {{'تهران'}}
                                    @elseif($bachelor->city == 'mashhad')
                                    {{'مشهد'}}
                                    @else
                                    {{'اصفهان'}}
                                    @endif
